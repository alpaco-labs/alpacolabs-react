...
const FAQSection = () => {
  ...
  // Removed faq.q7 ("Kaj pomeni »Izračunaj točno ceno«?") and faq.q8 ("Kaj če med izpolnjevanjem presežem obseg paketa?")
  const faqs = [
    ...
    { id: "7", questionKey: "faq.q9", answerKey: "faq.a9" },
    { id: "8", questionKey: "faq.q10", answerKey: "faq.a10" },
  ];
