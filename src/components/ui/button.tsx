  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body",
  {
    variants: {
      variant: {
        ...
        outline: "border border-border bg-transparent hover:bg-muted hover:border-foreground/20 rounded-md",
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80 rounded-md",
        ghost: "hover:bg-muted hover:text-foreground rounded-md",
        link: "text-foreground underline-offset-4 hover:underline",
        hero: "bg-primary text-primary-foreground hover:bg-primary/90 rounded-full shadow-subtle hover:shadow-card",
        "hero-outline": "border border-border bg-transparent text-foreground hover:bg-muted rounded-full",
        nav: "text-muted-foreground hover:text-foreground bg-transparent",
        cta: "bg-primary text-primary-foreground hover:bg-primary/90 rounded-full font-semibold tracking-tight",
      },
      size: {
