...
const HeroSection = () => {
  ...
  return <section className="relative min-h-[100vh] md:min-h-[90vh] flex items-center overflow-hidden pt-20 md:pt-24">
      ...
      <div className="relative z-10 container">
        <div className="grid md:grid-cols-2 gap-6 md:gap-12 items-center px-4 md:pb-[40px] md:py-[20px] py-[10px] pt-0 pb-[15px]">
          ...
          <div className="text-center md:text-left">
            ...
            animationDelay: "0.2s"
              ...
              <div className="md:hidden flex flex-col gap-5">
                <Button variant="hero" size="xl" className="w-full rounded-full" onClick={() => {
                ...
                <div className="relative">
                  ...
                  <Button variant="outline" size="xl" className="w-full rounded-full border-border/50 bg-transparent hover:bg-muted/50" asChild>
              ...
              <div className="hidden md:flex items-center gap-4">
                <Button variant="hero" size="xl" className="rounded-full" onClick={() => {
                const modal = document.querySelector('[data-inquiry-trigger]') as HTMLButtonElement;
                modal?.click();
              }}>
                  {t("inquiry.submit")}
                ...
                <div className="relative">
                  ...
                  <Button variant="outline" size="xl" className="rounded-full border-border/50 bg-transparent hover:bg-muted/50" onClick={() => setShowNumber(true)}>
                    <Phone size={18} />
          ...
          animationDelay: "0.2s"
            ...
            <img alt="Primeri spletnih strani na različnih napravah" className="w-full max-w-xl object-contain drop-shadow-2xl relative z-10" src="/lovable-uploads/7ac4c0a0-350c-406e-bd69-897ba3786f86.png" />
          </div>
        </div>
